...
public class ATM_main{
	public static void main(String[] args) {
        ...
        User aUser = theBank.addUser("Saurabh","kumar","1234");
		User aUser1=theBank.addUser("Priyanka","Kumari","1234");
		User aUser2=theBank.addUser("Shreya","Verma","1234");
		User aUser3= theBank.addUser("Aishwary Mani","Tripathi","1234");
		User aUser4=theBank.addUser("Ananya","Shreya","1234");
		User aUser5=theBank.addUser("Richa","Verma","1234");
		...
		Account newAccount5 = new Account("Checking",aUser5,theBank);
		...
		aUser3.addAccount(newAccount);
        theBank.addAccount(newAccount);
		aUser4.addAccount(newAccount1);
		theBank.addAccount(newAccount1);
		aUser5.addAccount(newAccount2);
		theBank.addAccount(newAccount2);
        ...
        while (true){
            ...
            curUser = ATM_main.mainMenuPrompt(theBank,sc);

            //stay in main menu until user quits
            ATM_main.printUserMenu(curUser,sc);
        }
    }
	...
	public static void printUserMenu(User theUser,Scanner sc){
        ...
        switch(choice){
            case 1:
                ATM_main.showTransactionHistory(theUser,sc);
                break;
            case 2:
                ATM_main.withdrawFunds(theUser,sc);
                break;
            case 3:
                ATM_main.depositeFunds(theUser,sc);
                break;
            case 4:
                ATM_main.transferFunds(theUser,sc);
                break;
            case 5:
        ...
        if(choice != 5){
            ATM_main.printUserMenu(theUser,sc);
        }
    }
